...
- [ ] 콘텐츠 분석 및 카드 구조화 (7장 확정: 후킹-쟁점-사례-법리-결과-팁-CTA), 04_PROJECT_SPEC.md "법률 광고 표현 규칙" 준수
- [ ] 카드별 캐릭터 배정: 훅·쟁점·사례는 의뢰인 캐릭터, 법리·팁·CTA는 한세영 변호사 캐릭터, 결과는 둘 다 (`templates/characters/`의 고정 자산 재사용 -- 매번 새로 생성하지 않음)
...
- 콘텐츠 분석 및 카드 구조화 (7장: 후킹-쟁점-사례-법리-결과-팁-CTA), 카드별로 의뢰인/변호사 캐릭터 중 정해진 배정을 따라 이미지 삽입
